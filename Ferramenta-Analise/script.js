...
const EXEMPLOS_LSB = [
    {
        ...
        descricao: 'Neste mapa LSB, o ruido aparece mais concentrado e com padroes visuais repetitivos. Esse tipo de distribuicao artificial dos bits menos significativos costuma ser um indicio de imagem sintetica.'
    },
    {
        rotulo: 'REAL',
        classe: 'real',
        ...
        descricao: 'Aqui a distribuicao dos pixels ativos fica mais irregular e organica, sem blocos tao consistentes. Esse comportamento tende a ser mais compativel com fotos reais sem marca embutida.'
    }
];
...
function carregarImagem(src) {
    return new Promise((resolve, reject) => {
        ...
        imagem.onerror = () => reject(new Error('Nao foi possivel carregar a imagem para gerar o recorte.'));
        imagem.src = src;
    });
}
        ...
        return [
            {
                rotulo: 'RECORTE',
                classe: 'recorte',
                titulo: 'Regiao usada para confirmar a logo',
                imagem: recorteContexto || imagemBase64,
                descricao: 'O detector procura a assinatura visual do Gemini no canto inferior direito. Esse recorte isola a area da foto em que a evidencia foi encontrada.'
            },
            {
                rotulo: 'LOGO',
                classe: 'recorte',
                titulo: 'Ampliacao da marca visual',
                imagem: recorteDetalhe || recorteContexto || imagemBase64,
                descricao: 'Este zoom ajuda a verificar se o simbolo esta consistente com a marca do Gemini. Quando a logo aparece nitida, a evidencia de geracao por IA fica mais forte.'
            }
        ];
    } catch (erro) {
    ...
    if (metodoRetornado.includes('lsb')) {
        renderizarCardsExemplo(
            ...
            elementos.lista,
            {
                ...
                descricao: 'Compare o seu resultado com estes exemplos. Padroes mais concentrados e repetitivos tendem a favorecer IA; distribuicoes mais organicas e irregulares tendem a favorecer imagem real.',
                itens: EXEMPLOS_LSB
            }
        );
        return;
    ...
    if (metodoRetornado.includes('marca visual') && metodoRetornado.includes('gemini')) {
        ...
        if (exemplosGemini.length > 0) {
            renderizarCardsExemplo(
                ...
                elementos.lista,
                {
                    titulo: 'Recortes da logo detectada',
                    descricao: 'A deteccao por marca visual encontrou a assinatura do Gemini. Os recortes abaixo mostram a regiao da foto usada para confirmar essa evidencia.',
